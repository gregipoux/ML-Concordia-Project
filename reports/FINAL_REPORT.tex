...
\item
  ...
  plateau at 0.745 across the board) is a more useful finding for the
...
If anything sticks beyond the F1 number, we hope it is the account of
why the metric plateaus where it does, and the UI that makes that
account visible at first click.
